      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl border border-primary/10 dark:border-gray-700">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-2">
            Bằng việc đăng ký, bạn đồng ý với <Link to="/terms" className="underline hover:text-primary">Điều khoản dịch vụ</Link> và <Link to="/privacy" className="underline hover:text-primary">Chính sách bảo mật</Link> của chúng tôi.
          </p>
        </div>
      </div>
    </div>
